...
1. Диаграмму контекста в модели С4.

Диаграмму контекста в модели С4, отражает контекст, в котором будут работать новые бизнес-функции.
...
Ссылка на перечисленные ниже требования к внешним интеграция:
